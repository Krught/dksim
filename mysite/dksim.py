    ...
    return html.Div(children=[
        ...
        html.Div([
            dash_table.DataTable(id='table',
                ...
                tooltip_data=[{
                    'Miss': {'value': '{}'.format(str(row['MissP'])), 'type': 'markdown'},
                    'Dodge': {'value': '{}'.format(str(row['DodgeP'])), 'type': 'markdown'},
                    'Parry': {'value': '{}'.format(str(row['ParryP'])), 'type': 'markdown'},
                    'Glance': {'value': '{}'.format(str(row['GlanceP'])), 'type': 'markdown'},
                    'Block': {'value': '{}'.format(str(row['BlockP'])), 'type': 'markdown'},
                    'Crit': {'value': '{}'.format(str(row['CritP'])), 'type': 'markdown'},
                    'Hit': {'value': '{}'.format(str(row['HitP'])), 'type': 'markdown'},
                    'DOT': {'value': '{}'.format(str(row['DOTP'])), 'type': 'markdown'},
                    'Active': {'value': '{}'.format(str(row['ActiveP'])), 'type': 'markdown'},
                    'Proc': {'value': '{}'.format(str(row['ProcP'])), 'type': 'markdown'},
...
def all_two_dash_stuff(datas, pas, quer):
    ...
    fig_log10 = px.histogram(datas, x="username", template="plotly_dark", title="Username Breakdown")
