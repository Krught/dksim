...
def all_dash_stuff(dash_all_data):
    ...
    fig250 = px.bar(x=bins1, y=counts1, labels={'x':'DPS', 'y':'Occurrence'}, title=fig_250_title, template="plotly_dark", color=counts1, color_continuous_scale="sunset", hovertext=[x, y])
