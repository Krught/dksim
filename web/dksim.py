...
#        simulation_amounts = 3000
    ...
    if pre_pop_pot == "prepoppotion":
        ...
        pre_pop_pot = False
    pre_armor_pot =  request.form.get("prearmorpotion")
    if pre_armor_pot == "prearmorpotion":
        pre_armor_pot = True
    elif pre_armor_pot != "prearmorpotion":
        pre_armor_pot = False
    greater_gift_wild =  request.form.get("greatergiftofthewild")
...
def all_dash_stuff(dash_all_data):
    ...
    fig250 = px.bar(x=bins1, y=counts1, labels={'x':'DPS', 'y':'Occurrence'}, title=fig_250_title, template="plotly_dark", color=counts1, color_continuous_scale="sunset", hover_data=["DPS", "Occurrence"])
