...
function getallselgear() {
    ...
    for (var i = 0; i < checkedBoxesLength; i++) {
        ...
        selcheckedbox_item = selcheckedbox_item.replace("w1_", "mh_");
        selcheckedbox_item = selcheckedbox_item.replace("w2_", "oh_");
        selcheckedbox_item = selcheckedbox_item.replace("Headd_", "head_");
        selcheckedbox_item = selcheckedbox_item.replace("Neckk_", "neck_");
        selcheckedbox_item = selcheckedbox_item.replace("Shouls_", "shoulders_");
        selcheckedbox_item = selcheckedbox_item.replace("Backk_", "back_");
        selcheckedbox_item = selcheckedbox_item.replace("Chestt_", "chest_");
        selcheckedbox_item = selcheckedbox_item.replace("Wristt_", "wrist_");
        selcheckedbox_item = selcheckedbox_item.replace("Gloves_", "gloves_");
        selcheckedbox_item = selcheckedbox_item.replace("Waistt_", "waist_");
        selcheckedbox_item = selcheckedbox_item.replace("Legss_", "legs_");
        selcheckedbox_item = selcheckedbox_item.replace("Bootss_", "boots_");
        selcheckedbox_item = selcheckedbox_item.replace("Sigill_", "sigil_");
        selcheckedbox_item = selcheckedbox_item.replace("Ringg1_", "ring1_");
        selcheckedbox_item = selcheckedbox_item.replace("Ringg2_", "ring2_");
        selcheckedbox_item = selcheckedbox_item.replace("Trinkt1_", "trinket1_");
        selcheckedbox_item = selcheckedbox_item.replace("Trinkt2_", "trinket2_");
