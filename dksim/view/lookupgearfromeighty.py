import pandas as pd
gems_data =  pd.read_csv (r'dksim/view/dk/csv/EquipmentList - Gems.csv')
all_selectable_gear = pd.read_csv (r'dksim/view/dk/csv/EquipmentList - Gear.csv')
all_selectable_weps = pd.read_csv (r'dksim/view/dk/csv/EquipmentList - Weapons.csv')
